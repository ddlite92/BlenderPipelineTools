...
- function to get 
    ...
    - folder
    - scene
- scene_names function get the first scene only, need to change to index 1,2,3,4 respectively
...
def scene_name():
    ...
    # scene_names get the first scene, need to change to index 1,2,3,4 respectively
...
def output_node():
    for node in mainScreen.scene.node_tree.nodes:
        ...
        if not nodeBeauty:
            ...
            node.base_path = path + "\\" + folder() + "\\" + scene_name() + "\\" + node.label + "\\"
